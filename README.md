...
| [`shunk031-github-comment-attach-files`](skills/shunk031-github-comment-attach-files/)                         | `github`      | Attaches local files to GitHub pull request descriptions and issue or pull request comments with the GitHub CLI.            |
