...
この構造は、[先生の「まずは論文の骨子を箇条書きで書いてみて」に対応する](https://shunk031.hatenablog.com/entry/lets-write-outline)の定義に基づく。

- 骨子箇条書きは、パラグラフ・ライティングの構造を箇条書きへ移し、与えられた素材を「論点文」と「支える事実」の階層に整理する
...
```markdown
- top-level: トピックセンテンス
  - support-level: サポートセンテンス
    - サポートセンテンスをさらに説明する文
  - support-level: 小結論センテンス
```

トピックセンテンスから小結論センテンスまでを一つのパラグラフとする。小結論センテンスはサポートセンテンスと同じインデントに置き、パラグラフの最後を締める。
...
- 各論点の下には、必要な範囲で 2〜3 本程度の支えを置く
  ...
  - サポートセンテンスをさらに説明する場合は、インデントをもう一段深くする
  - 一つのまとまりには一つの論点だけを入れる
  - 論点が混ざる場合は、短く押し込まずに分ける
  - 各パラグラフの最後は、そこまでの流れを閉じる小結論センテンスで締める
